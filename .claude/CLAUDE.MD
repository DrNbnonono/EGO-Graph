...
- TUI keeps a conversation-first Agent Kernel view, multi-file diff browsing, slash command palette, MCP discovery, and approval shortcuts while still pointing users to `ego serve` for full management pages.
